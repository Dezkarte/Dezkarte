...
JailBreak Es un simple BOT de whatsapp creado sin fines de lucro.

*JailBreak © Todos los derechos reservados.*`
}
...
exports.textMenu = (pushname) => {
    return `
Menú JailBreak!, ${pushname} como puedo ayudarte?
...
-❥ *${prefix}nulis*
Crear textos en un cuaderno. ejemplo : *$nulis HOLA, y el bot creara una imagen con tu texto en una hoja de cuaderno.*
...
-❥ *${prefix}images*
Buscar imagenes el google. *EJEMPLO : $images Demon*

-❥ *${prefix}sreddit*
Para buscar imágenes en el sub de reddit. *EJEMPLO : $sreddit Demon*
...
Estadisticas de JailBreak en el grupo o chat.

-❥ *${prefix}join*
Si quieres que el BOT entre a algun grupo solo envia *$join Y EL ENLACE DEL GRUPO*`
}
...
-❥ *${prefix}del*
Borrar mensajes enviados por el bot.

-❥ *${prefix}bye*
Hacer que el bot salga solo del grupo.
