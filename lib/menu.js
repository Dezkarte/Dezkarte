...
*DEMON © Todos los derechos reservados.*`
}
...
Estadisticas de demon en el grupo o chat.

-❥ *${prefix}join*
Si quieres que Demon-BOT entre a algun grupo solo envia *#join Y EL ENLACE DEL GRUPO*`
}
...
Estos son los comandos de administrador que tiene demon!
...
-❥ *${prefix}del*
Borrar mensajes enviados por Demon-BOT.

-❥ *${prefix}bye*
Hacer que demon salga solo del grupo.

_-_-_-_-_-_-_-_-_-_-_-_-_-_

⚠ [ *Comando Solo Para Creador*] ⚠
Estos son los comandos de creador que tiene demon!
-❥ *${prefix}kickall*
